...
public class MatrixResult {
    ...
    private List<List<EdgeDetail>> detailsMatrix;
    ...
    public List<List<EdgeDetail>> getDetailsMatrix() {
        return detailsMatrix;
    }

    public void setDetailsMatrix(List<List<EdgeDetail>> detailsMatrix) {
        this.detailsMatrix = detailsMatrix;
    }
}
